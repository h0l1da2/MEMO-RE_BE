...
public class MemoController {
    ...
    @DeleteMapping
    public ResponseEntity<String> deleteMemo(@RequestBody String keyword, HttpServletRequest request) throws UserNotFoundException, MemoNotFoundException {
        JsonObject jsonObject = new JsonObject();
        Long id = webService.getIdInHeader(request);
    ...
    @PutMapping
    public ResponseEntity<String> changeMemo(@RequestBody @Valid MemoUpdateDto memoUpdateDto, HttpServletRequest request) throws UserNotFoundException, DuplicateMemoException, MemoNotFoundException {
        /**
         * 원래 키워드 확인 후,
         * 있다면 전부 수정
         * 태그테이블도 삭제
    ...
    @PostMapping
    public ResponseEntity<String> write(@RequestBody @Valid MemoWriteDto memoWriteDto, HttpServletRequest request) throws UserNotFoundException, DuplicateMemoException {
